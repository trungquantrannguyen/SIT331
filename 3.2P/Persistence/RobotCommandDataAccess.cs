...
public static class RobotCommandDataAccess
{
    ...
    public static void UpdateRobotCommand(int id, string name, string? description, bool isMoveCommand)
    {
    ...
    public static RobotCommand InsertRobotCommand(string name, string? description, bool isMoveCommand)
    {
        using var conn = new NpgsqlConnection(CONNECTION_STRING);
        conn.Open();
